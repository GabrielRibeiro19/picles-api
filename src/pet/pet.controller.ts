...
export class PetController {
  ...
  private readonly deletePetByIdUseCase: IUseCase<DeletePetByIdUseCaseInput, UpdatePetByIdUseCaseOutput>
  ...
  @Delete(':id')
  async deletePet(@Param('id') id: string): Promise<DeletePetByIdUseCaseInput> {
    try {
